      ...
      <div>
        ...
        <div className="flex flex-wrap justify-evenly p-4">
          <div>
            ...
            <h1
              className="cursor-pointer"
              onClick={() => props?.setMenu("Coronavirus")}
            >
              Coronavirus
            </h1>
            <h1
              className="cursor-pointer"
              onClick={() => props?.setMenu("U.S.World")}
            >
              U.S.World
            </h1>
            <h1
              className="cursor-pointer"
              onClick={() => props?.setMenu("U.S.Politics")}
            >
              U.S.Politics
            </h1>
          </div>
          <div className="ml-5 mb-2">
            ...
            <h1
              className="cursor-pointer"
              onClick={() => props?.setMenu("Editorials")}
            >
              Editorials
            </h1>
            <h1
            ...
            <h1
              className="cursor-pointer"
              onClick={() => props?.setMenu("Letters")}
            >
              Letters
            </h1>
            <h1
              className="cursor-pointer"
              onClick={() => props?.setMenu("Columnists")}
            >
              Columnists
            </h1>
          </div>
          <div className="ml-5 mb-2">
            ...
            <h1
              className="cursor-pointer"
              onClick={() => props?.setMenu("Music")}
            >
              Music
            </h1>
            <h1
              className="cursor-pointer"
              onClick={() => props?.setMenu("Dance")}
            >
              Dance
            </h1>
          </div>
          <div className="ml-5 mb-2">
            ...
            <h1
              className="cursor-pointer"
              onClick={() => props?.setMenu("Love")}
            >
              Love
            </h1>
            <h1
              className="cursor-pointer"
              onClick={() => props?.setMenu("Job")}
            >
              Job
            </h1>
          </div>
          <div className="ml-5 mb-2">
            ...
            <h1
              className="cursor-pointer"
              onClick={() => props?.setMenu("Podcasts")}
            >
              Podcasts
            </h1>
            <h1
            ...
            <h1
              className="cursor-pointer"
              onClick={() => props?.setMenu("Articles")}
            >
              Articles
            </h1>
          </div>
